...
export const ForgotPasswordPage = () => {
  const { mutate, isPending } = useForgotPassword(() => {
    localStorage.setItem("reset-password-email", forgotPasswordValues.email);
  });
  ...
  return (
    <motion.div
      ...
      className="grid gap-7 p-7 lg:p-8 bg-white max-w-md w-full h-fit place-self-center rounded-xl"
    >
