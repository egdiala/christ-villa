...
export const TimeOffRequestModal = ({
  ...
  return (
    ...
    >
      <DialogPanel className="max-w-[361px] w-[calc(100%-20px)] md:w-[361px] space-y-3 bg-white p-4 rounded-lg overflow-y-scroll">
        ...
        <Description className="grid gap-y-3">
          ...
          <div className="grid gap-y-1 text-xs">
            ...
            <p className="text-text-secondary">
              Lorem ipsum dolor sit amet consectetur. In nascetur eleifend nunc
              tortor a neque mauris eu senectus. Scelerisque aliquet sociis nec
              id.{" "}
            </p>
          </div>
