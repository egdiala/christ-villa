...
export const UpdateRequestStatusModal = ({ isOpen, onClose, activeRequest }: UpdateRequestStatusModalProps) => {
                ...
                <div className="flex flex-col min-h-full items-center p-3 justify-end md:justify-center">
                    <DialogPanel as="form" onSubmit={handleSubmit} transition className="flex flex-col gap-5 justify-between w-full max-w-[30.8125rem] rounded-lg bg-white p-4 md:p-5 backdrop-blur-2xl duration-300 ease-out transform data-[closed]:translate-y-full">
                        <div className="flex items-center justify-between gap-3">
                            <DialogTitle className="font-bold text-text-primary text-xl">Update Request Status</DialogTitle>
                        ...
                        <div className="space-y-6">
                            <SelectInput label="Select New Status" options={genders} {...register("status")} />
                        </div>
